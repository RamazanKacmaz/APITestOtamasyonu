...
public class TestDataDummyExampel {
...
"message": "Successfully! Record has been fetched."
    ...
    public static String contenteyp ="application/json";


    public static JSONObject reponseJsonBodyOlustur(int id , String employee_name,int employee_salary,int employee_age,String profile_image){
